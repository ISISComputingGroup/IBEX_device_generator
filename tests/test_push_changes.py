...
class TestPushingChangesToGit(unittest.TestCase):
    ...
    def test_that_GIVEN_a_clean_Git_repo_WHEN_pushing_changes_with_one_file_THEN_only_that_one_file_is_pushed(self):
        # When:
    ...
    def test_that_GIVEN_a_clean_Git_repo_WHEN_pushing_changes_with_no_files_specified_THEN_git_addes_all_files(self):
        # When:
    ...
    def test_that_GIVEN_a_clean_Git_repo_WHEN_pushing_changes_with_two_files_specified_THEN_git_adds_only_these_two_files(
            self):
        # When:
