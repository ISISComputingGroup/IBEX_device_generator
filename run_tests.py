...
from tests.git_utils_tests import GitRepoTests, GitExceptionTests
from tests.ioc_generator_tests import IocGeneratorTests
...
def run_tests(test_reports_path=DEFAULT_TEST_LOCATION):
    ...
    for case in [GitRepoTests, GitExceptionTests, IocGeneratorTests]:
